...
```hcl
module "deploy" {
  source                    = "git::https://github.com/ministryofjustice/terraform-ecs//service"
  ...
  ecs_load_balancers = [
    {
      target_group_arn = "arn:aws:elasticloadbalancing:${data.aws_region.current.name}:${data.aws_caller_identity.current.account_id}:targetgroup/tg-name/9dce0b9265ed25e0"
      container_name   = local.app_name
      container_port   = 5000
    }
  ]

  security_group_ids    = ["sg-123456789101112"]
  alb_security_group_id = "sg-2345678910111213"
